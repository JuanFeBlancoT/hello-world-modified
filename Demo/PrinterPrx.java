...
public interface PrinterPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default int fibo(int a, int b)
    {
        return fibo(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int fibo(int a, int b, java.util.Map<String, String> context)
    {
        return _iceI_fiboAsync(a, b, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> fiboAsync(int a, int b)
    {
        return _iceI_fiboAsync(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> fiboAsync(int a, int b, java.util.Map<String, String> context)
    {
        return _iceI_fiboAsync(a, b, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_fiboAsync(int iceP_a, int iceP_b, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "fibo", null, sync, null);
    ...
    default String fibonacciMethod(String number)
    {
        return fibonacciMethod(number, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String fibonacciMethod(String number, java.util.Map<String, String> context)
    {
        return _iceI_fibonacciMethodAsync(number, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> fibonacciMethodAsync(String number)
    {
        return _iceI_fibonacciMethodAsync(number, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> fibonacciMethodAsync(String number, java.util.Map<String, String> context)
    {
        return _iceI_fibonacciMethodAsync(number, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_fibonacciMethodAsync(String iceP_number, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "fibonacciMethod", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(iceP_number);
                 }, istr -> {
                     String ret;
                     ret = istr.readString();
                     return ret;
